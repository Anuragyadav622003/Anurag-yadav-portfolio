...
const skillCategories = [
  {
    ...
    skills: [
      { name: "React", level: 95, years: 2, projects: 5 },
      { name: "NextJS", level: 78, years: 1, projects: 4 },
      { name: "TypeScript/JavaScript", level: 85, years: 1, projects: 3 },
      { name: "Tailwind CSS", level: 90, years: 2, projects: 8 },
  ...
  },
  {
    ...
    skills: [
      { name: "NodeJS/ExpressJS", level: 90, years: 2, projects: 5 },
       { name: "NestJS", level: 90, years: 1, projects: 3 },
      { name: "PostgreSQL", level: 75, years: 1, projects: 3 },
      { name: "MongoDB", level: 85, years: 2, projects: 5 },
  ...
  },
  {
    ...
    skills: [
      { name: "Python", level: 80, years: 1, projects: 3 },
      // { name: 'TensorFlow/PyTorch', level: 88, years: 2, projects: 8 },
      { name: "Scikit-learn", level: 85, years: 1, projects: 3 },
      { name: "Pandas/NumPy", level: 89, years: 1, projects: 2 },
      { name: "Matplotlib/Seaborn", level: 85, years: 1, projects: 2 },
    ],
  ...
  },
  {
    ...
    skills: [
      { name: "Git/GitHub", level: 85, years: 3, projects: 15 },
      { name: "Postman", level: 86, years: 2, projects: 10 },
      { name: "Jira", level: 89, years: 2, projects: 2 },
      //{ name: "Kubernetes", level: 82, years: 1, projects: 5 },
      { name: "Linux/ Bash", level: 75, years: 3, projects: 2 },
    ],
    ...
    <section id="skills" className="py-32 relative overflow-hidden">
      ...
      <div ref={ref} className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            Mastering the full stack – from pixel-perfect UIs to scalable cloud
            infrastructure
          </motion.p>
        </motion.div>
                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <motion.span
                        ...
                        transition={{
                          delay: categoryIndex * 0.1 + index * 0.1 + 0.5,
                        }}
                      ...
                      {hoveredSkill === skill.name && (
                        ...
                        >
                          ...
                          <div className="text-xs text-gray-300 mt-1">
                            {skill.years} years experience • {skill.projects}{" "}
                            projects
                          </div>
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`text-5xl font-black bg-gradient-to-r ${color} bg-clip-text text-transparent mb-3 group-hover:scale-110 transition-transform duration-300`}
      >
        {number}
      </div>
